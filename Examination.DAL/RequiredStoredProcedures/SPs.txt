...
//select u.FirstName, u.LastName, u.Age, u.Email, u.Phone, u.Status, s.EnrollmentDate, s.TrackType, s.DateOfBirth from Students s 
//join Users u on s.UserId=u.Id 
//where s.DepartmentBranchId=@DepartmentBranchId
//end
//    ')
//END;");
...
//    BEGIN
//        SET NOCOUNT ON;
//       select U.FirstName,U.LastName,c.Name,sc.FinalGradePercent 
//using Examination.DAL.Entities;

//from Student_Courses sc inner
//join Students s on s.Id = sc.StudentId inner
...
//            AS
//            BEGIN
//                select S.id,concat(U.FirstName,' ',U.LastName) As Name from Students S
//                    join Users U on U.Id=S.UserId
//            END;
//            ')
//        END;
