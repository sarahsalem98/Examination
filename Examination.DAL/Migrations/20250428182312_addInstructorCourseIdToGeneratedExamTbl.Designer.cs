...
namespace Examination.DAL.Migrations
{
    ...
    [Migration("20250428182312_addInstructorCourseIdToGeneratedExamTbl")]
    partial class addInstructorCourseIdToGeneratedExamTbl
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Examination.DAL.Entities.GeneratedExam", b =>
                {
                    ...
                    b.Property<int?>("CountMCQ")
                        .HasColumnType("int");

                    b.Property<int?>("CountTF")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Examination.DAL.Entities.InstructorCourse", b =>
                {
                    ...
                    b.Property<int?>("CorrectivePassedStudentCount")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("FinalPassedStudentCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Examination.DAL.Entities.GeneratedExam", b =>
                {
                    ...
                    b.HasOne("Examination.DAL.Entities.InstructorCourse", "InstructorCourse")
                        .WithMany("GeneratedExams")
